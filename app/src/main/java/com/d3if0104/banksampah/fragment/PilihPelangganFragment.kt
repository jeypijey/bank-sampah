...
import com.d3if0104.banksampah.adapter.AdapterPilihPelanggan
//import com.d3if0104.banksampah.databinding.FragmentPelangganBinding
import com.d3if0104.banksampah.databinding.FragmentPilihPelangganBinding
...
class PilihPelangganFragment : Fragment() {
    private lateinit var binding: FragmentPilihPelangganBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPilihPelangganBinding.inflate(layoutInflater)
        ...
        recyclerView = binding.rvPelanggan
        recyclerView.layoutManager = LinearLayoutManager(context)
        recyclerView.setHasFixedSize(true)

        adapter = AdapterPilihPelanggan(
            arrayListOf(),
            object : AdapterPilihPelanggan.OnItemClicklistener {
                override fun onItemClick(pelanggan: User, v: View) {
                    val id = pelanggan.id
                    val nama = pelanggan.nama
                    setFragmentResult(
                        "nama",
                        bundleOf("nama" to nama, "id" to id)
                    )
